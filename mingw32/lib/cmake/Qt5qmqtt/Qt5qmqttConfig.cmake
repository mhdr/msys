...
macro(_populate_qmqtt_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt5qmqtt_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::qmqtt PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt5qmqtt_LIB_DEPENDENCIES}${_list_sep}${_Qt5qmqtt_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5qmqtt_LIB_DEPENDENCIES}${_list_sep}${_Qt5qmqtt_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::qmqtt)
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt5qmqtt_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            ...
            file(STRINGS ${pluginTarget} matched REGEX Qt5qmqtt_PLUGINS)
            if (matched)
    ...
    macro(_populate_qmqtt_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5qmqtt_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_qmqtt_check_file_exists(${imported_location})
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt5qmqtt_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_qmqtt_target_properties(RELEASE "Qt5qmqtt.dll" "libQt5qmqtt.dll.a" )



    _populate_qmqtt_target_properties(DEBUG "Qt5qmqttd.dll" "libQt5qmqttd.dll.a" )
